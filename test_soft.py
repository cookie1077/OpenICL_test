...
train_ds = Dataset.from_generator(gen, gen_kwargs={"file_path": "data/train_new.jsonl"})
val_ds = Dataset.from_generator(gen, gen_kwargs={"file_path": "data/dev.jsonl"})
test_ds = Dataset.from_generator(gen, gen_kwargs={"file_path": "data/test_new.jsonl"})
...
# TODO : need to distinguish between icl template and prompt template. 
tp_dict = {
